...
{Course Project}
{\href{https://drive.google.com/file/d/1EF9wtUCJqQINYWiY4uFL4mmktJBL6r1b/view?usp=sharing}{\textbf{Data Analysis and Visualisation with Pandas}}}
{
    \begin{itemize}
...
{
    \begin{itemize}
        \item Assess the ability of users to be random by asking them to click six identical buttons in a random fashion.
